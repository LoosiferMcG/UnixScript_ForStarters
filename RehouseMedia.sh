...
# RehouseMedia.sh
# Shell script to move media files to a different folder organized by year and month
#
# Usage:
#     ./RehouseMedia.sh {Media file pattern} {target owner}
# Example:
#     ./RehouseMedia.sh *.jpg LoosiferMcG
#
...
if [ -z "$2" ]; then
  ...
  exit 1
elif [ -f "$HOME/Dropbox/Stored Photos for ${2}" ]; then
